<template>
  <div class="container">
    ...
    <div class="form-group">
      ...
      <input type="number" id="currentPage" v-model="curPage" @input="updatePage" min="1" :max="totalPages" />
    </div>
    <div class="form-group">
    ...
    <div class="pagination">
      <button @click="goToPage(1)" :disabled="curPage === 1">首页</button>
      <button @click="goToPage(curPage - 1)" :disabled="curPage === 1">上一页</button>
      <span>第{{ curPage }}页 / 共{{ totalPages }}页</span>
      <button @click="goToPage(curPage + 1)" :disabled="curPage === totalPages">下一页</button>
      <button @click="goToPage(totalPages)" :disabled="curPage === totalPages">末页</button>
    </div>
  </div>
</template>
