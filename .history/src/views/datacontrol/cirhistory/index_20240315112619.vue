<template>
  <div class="container">
    ...
    <div class="form-group">
      ...
      <input type="number" id="curPage" v-model.number="curPage" min="1" :max="totalPages"  class="form-control" />
      <label for="perPage">每页显示条数:</label>
      <input type="number" id="perPage" v-model.number="perPage" min="1" class="form-control"/>
